...
namespace Green
{
  public class CheckTests
  {
    ...
    public void Converts_ToBoolean()
    {
      // Arrage
      var applied = false;
      var check = Check.That(_target).That(_ => applied = true);
    ...
    public void That_AppliesNext()
    {
      // Arrange
      var applied = false;
      var check = Check.That(_target).That(_ => { applied = true; return true; });
    ...
    public void Not_AppliesNext()
    {
      // Arrange
      var applied = false;
      var check = Check.That(_target).Not(_ => { applied = true; return true; });
    ...
    {
      // Arrange
      var check = Check.That(_target).Not();
    ...
    {
      // Arrange
      var check = Check.That(_target).That(_ => true).Not();
